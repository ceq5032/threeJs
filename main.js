...
const texTexture = new THREE.TextureLoader().load('images/laLogo.jpg');
const skyTexture = new THREE.TextureLoader().load('images/night_sky.jpg');
const laTexture = new THREE.TextureLoader().load('images/texture.jpg');
...
const icoMaterial = new THREE.MeshPhongMaterial({color: 0x33AADD, map: skyTexture, shininess: 75});

const icoMesh = new THREE.Mesh(ico, icoMaterial);
// object.position.set ( x, y, z );
icoMesh.position.set(80, -15, -65)

const sphereGeo = new THREE.SphereGeometry(20, 32, 16);
const sphereMaterial = new THREE.MeshBasicMaterial({map: texTexture});
const sphere = new THREE.Mesh(sphereGeo, sphereMaterial);
scene.add(sphere);
// object.position.set ( x, y, z );
sphere.position.set(-80, 5, -45)
